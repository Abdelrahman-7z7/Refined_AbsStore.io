        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2.5 pr-10 border rounded-lg focus:ring-2 focus:ring-[#369e62] focus:border-[#369e62] transition-colors duration-200 ${
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs text-[#369e62] hover:text-[#008000] font-medium transition-colors duration-200"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-4">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <motion.button
                type="button"
                className="w-full inline-flex justify-center py-2 px-3 border border-gray-300 rounded-lg shadow-sm bg-white text-xs font-medium text-gray-500 hover:bg-gray-50 transition-colors duration-200"
