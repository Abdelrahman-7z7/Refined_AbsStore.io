        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600">
              Join AbsStore and start shopping today
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#369e62] focus:border-[#369e62] transition-colors duration-200 ${
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-4 w-4 text-[#369e62] focus:ring-[#369e62] border-gray-300 rounded mt-1"
                />
                <label htmlFor="agreeToTerms" className="ml-2 block text-sm text-gray-700">
                  I agree to the{' '}
                  <Link href="/terms" className="text-[#369e62] hover:text-[#008000] font-medium">
                    Terms and Conditions
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-[#369e62] hover:text-[#008000] font-medium">
                    Privacy Policy
                  </Link>
                </label>
              </div>
